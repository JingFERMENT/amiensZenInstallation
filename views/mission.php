<section class="container pb-5" id="our-mission">
    <div class="row">
        ...
        <div class="col-12 col-xl-6 bg-light text-center p-5">
            <h5 class="fw-bold pb-2">Installer de manière zen</h5>
    ...
    <div class="col-12 text-center">
        <p class="mt-5">Si vous souhaitez nous contacter, ça se passe par ici  :</p>
        <a class="text-white btn btn-lg mb-3" href="http://amienszeninstallation.localhost/controllers/contact-ctrl.php" id="btn-send-contact" role="button">Nous contacter</a>
    </div>
</section>