            ...
            <div class="card">
                ...
                <div class="p-4">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <p class="lead fw-bold">Modifier l'article</p>
                    </div>
                    <?php if (!empty($msg)) { ?>
                    ...
                    <form class="my-4" method="POST" name="writeArticle" enctype='multipart/form-data' novalidate>
                        <div class="d-flex flex-wrap">
                            ...
                            <div class="col-12 p-2">
                                ...
                                <input class="form-control" id="title" name="title" value="<?= $postToDisplay->title ?? '' ?>" placeholder="Ecrire votre titre ici ..." required>
