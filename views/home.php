...
<section class="container p-5" id="our-mission">
    <div class="row">
        ...
        <div class="col-12 col-xl-6 bg-light text-center p-5 ">
            ...
            <h5 class="fw-bold pt-5">Découvrir le meilleur d'Amiens</h5>
...
<section class="container pb-5">
    <div class="row d-flex flex-wrap">
        <h2 class="text-center fw-bold pt-5 pb-2">Toutes les rubriques pour une installation zen</h2>
        ...
        <div class="col-12 col-md-6 col-lg-3 mb-3 ">
            <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    <a href="../controllers/work-ctrl.php" class="btn text-white" id="btn-send-contact">Découvrir plus</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-md-6 col-lg-3 mb-3 ">
            <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    <a href="../controllers/accommodation-ctrl.php" class="btn text-white" id="btn-send-contact">Découvrir plus</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-md-6 col-lg-3 mb-3 ">
            <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    <a href="../controllers/life-ctrl.php" class="btn text-white" id="btn-send-contact">Découvrir plus</a>
                </div>
            </div>
        </div>
</section>
