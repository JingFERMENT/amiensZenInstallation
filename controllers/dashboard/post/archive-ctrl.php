...
try {
    ...
    $title = "Liste des articles archivés";
    ...
    if ($idPost) {
        ...
        $isArchived = Post::archive($idPost);
        $msg = 'Article archivé avec succès.';
        $_SESSION['msg'] = $msg;
        // redirection vers la liste des archives
        header('Location: /controllers/dashboard/post/archive-ctrl.php');
        die();
    }

    // DEUXIEME CAS - il y a PAS un id_post : afficher les posts archivés
    $posts = Post::getAll(isArchived: true);
